                    ...
                    <div class="body">
                        ...
                        <div class="form-group">
                            <div class="demo-radio-button">
                                <input type="radio" id="male" name="jenis_kelamin" value="Laki - laki" value="{{ old('jenis_kelamin') }}">
                                <label for="male" style="padding-left: 0px; min-width: 100px;">Laki - laki</label>
                                <input type="radio" id="female" name="jenis_kelamin" value="Perempuan" style="margin-right: -10">
            ...
            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="body">
                        ...
                        <div class="form-group form-float">
                            <div class="form-line">
                                <input type="text" name="golongan_darah" class="form-control" value="{{ old('golonggan_darah') }}">
