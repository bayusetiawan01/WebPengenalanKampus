        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                ...
                <div class="body clearfix" style="padding: 50px; padding-top:10px">
                    ...
                    Terimakasih kamu telah memilih kegiatan pemetaan Internship Program BEM Kema FMIPA Unpad sebagai pilihan kedua.<br><br>
                    ...
                    <form id="form" action="/user/pemetaan/store/4" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <select id="pilihan21" name="pilihan21">
                                <option value="Biro Kesekretariatan" <?php if ($pemetaan->pilihan21 == 'Biro Kesekretariatan') : ?> selected <?php endif ?>>Biro Kesekretariatan</option>
                                <option value="Biro Keuangan" <?php if ($pemetaan->pilihan21 == 'Biro Keuangan') : ?> selected <?php endif ?>>Biro Keuangan</option>
                                <option value="Biro Kewirausahaan" <?php if ($pemetaan->pilihan21 == 'Biro Kewirausahaan') : ?> selected <?php endif ?>>Biro Kewirausahaan</option>
                                <option value="Biro Pengembangan Internal Organisasi" <?php if ($pemetaan->pilihan21 == 'Biro Pengembangan Internal Organisasi') : ?> selected <?php endif ?>>Biro Pengembangan Internal Organisasi</option>
                                <option value="Departemen Kaderisasi" <?php if ($pemetaan->pilihan21 == 'Departemen Kaderisasi') : ?> selected <?php endif ?>>Departemen Kaderisasi</option>
                                <option value="Departemen Olahraga, Seni, dan Budaya" <?php if ($pemetaan->pilihan21 == 'Departemen Olahraga, Seni, dan Budaya') : ?> selected <?php endif ?>>Departemen Olahraga, Seni, dan Budaya</option>
                                <option value="Departemen Akademik dan Penalaran" <?php if ($pemetaan->pilihan21 == 'Departemen Akademik dan Penalaran') : ?> selected <?php endif ?>>Departemen Akademik dan Penalaran</option>
                                <option value="Departemen Sosial Kemasyarakatan" <?php if ($pemetaan->pilihan21 == 'Departemen Sosial Kemasyarakatan') : ?> selected <?php endif ?>>Departemen Sosial Kemasyarakatan</option>
                                <option value="Departemen Kajian dan Aksi Strategis" <?php if ($pemetaan->pilihan21 == 'Departemen Kajian dan Aksi Strategis') : ?> selected <?php endif ?>>Departemen Kajian dan Aksi Strategis</option>
                                <option value="Departemen Advokasi dan Pelayanan Mahasiswa" <?php if ($pemetaan->pilihan21 == 'Departemen Advokasi dan Pelayanan Mahasiswa') : ?> selected <?php endif ?>>Departemen Advokasi dan Pelayanan Mahasiswa</option>
                                <option value="Departemen Media Informasi" <?php if ($pemetaan->pilihan21 == 'Departemen Media Informasi') : ?> selected <?php endif ?>>Departemen Media Informasi</option>
                                <option value="Departemen Hubungan Internal" <?php if ($pemetaan->pilihan21 == 'Departemen Hubungan Internal') : ?> selected <?php endif ?>>Departemen Hubungan Internal</option>
                                <option value="Departemen Hubungan Eksternal" <?php if ($pemetaan->pilihan21 == 'Departemen Hubungan Eksternal') : ?> selected <?php endif ?>>Departemen Hubungan Eksternal</option>
                                <option value="Departemen Pusat Data Teknologi" <?php if ($pemetaan->pilihan21 == 'Departemen Pusat Data Teknologi') : ?> selected <?php endif ?>>Departemen Pusat Data Teknologi</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <label for="pilihan22">Pilihan 2</label>
                            <select id="pilihan22" name="pilihan22">
                                <option value="Biro Kesekretariatan" <?php if ($pemetaan->pilihan22 == 'Biro Kesekretariatan') : ?> selected <?php endif ?>>Biro Kesekretariatan</option>
                                <option value="Biro Keuangan" <?php if ($pemetaan->pilihan22 == 'Biro Keuangan') : ?> selected <?php endif ?>>Biro Keuangan</option>
                                <option value="Biro Kewirausahaan" <?php if ($pemetaan->pilihan22 == 'Biro Kewirausahaan') : ?> selected <?php endif ?>>Biro Kewirausahaan</option>
                                <option value="Biro Pengembangan Internal Organisasi" <?php if ($pemetaan->pilihan22 == 'Biro Pengembangan Internal Organisasi') : ?> selected <?php endif ?>>Biro Pengembangan Internal Organisasi</option>
                                <option value="Departemen Kaderisasi" <?php if ($pemetaan->pilihan22 == 'Departemen Kaderisasi') : ?> selected <?php endif ?>>Departemen Kaderisasi</option>
                                <option value="Departemen Olahraga, Seni, dan Budaya" <?php if ($pemetaan->pilihan22 == 'Departemen Olahraga, Seni, dan Budaya') : ?> selected <?php endif ?>>Departemen Olahraga, Seni, dan Budaya</option>
                                <option value="Departemen Akademik dan Penalaran" <?php if ($pemetaan->pilihan22 == 'Departemen Akademik dan Penalaran') : ?> selected <?php endif ?>>Departemen Akademik dan Penalaran</option>
                                <option value="Departemen Sosial Kemasyarakatan" <?php if ($pemetaan->pilihan22 == 'Departemen Sosial Kemasyarakatan') : ?> selected <?php endif ?>>Departemen Sosial Kemasyarakatan</option>
                                <option value="Departemen Kajian dan Aksi Strategis" <?php if ($pemetaan->pilihan22 == 'Departemen Kajian dan Aksi Strategis') : ?> selected <?php endif ?>>Departemen Kajian dan Aksi Strategis</option>
                                <option value="Departemen Advokasi dan Pelayanan Mahasiswa" <?php if ($pemetaan->pilihan22 == 'Departemen Advokasi dan Pelayanan Mahasiswa') : ?> selected <?php endif ?>>Departemen Advokasi dan Pelayanan Mahasiswa</option>
                                <option value="Departemen Media Informasi" <?php if ($pemetaan->pilihan22 == 'Departemen Media Informasi') : ?> selected <?php endif ?>>Departemen Media Informasi</option>
                                <option value="Departemen Hubungan Internal" <?php if ($pemetaan->pilihan22 == 'Departemen Hubungan Internal') : ?> selected <?php endif ?>>Departemen Hubungan Internal</option>
                                <option value="Departemen Hubungan Eksternal" <?php if ($pemetaan->pilihan22 == 'Departemen Hubungan Eksternal') : ?> selected <?php endif ?>>Departemen Hubungan Eksternal</option>
                                <option value="Departemen Pusat Data Teknologi" <?php if ($pemetaan->pilihan22 == 'Departemen Pusat Data Teknologi') : ?> selected <?php endif ?>>Departemen Pusat Data Teknologi</option>
                            </select>
                        </div>
