        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                ...
                <div class="body clearfix" style="padding: 50px; padding-top:10px">
                    ...
                    Terimakasih kamu telah memilih kegiatan pemetaan Pengenalan Karya Tulis Ilmiah sebagai pilihan pertama.<br><br>
                    ...
                    <form id="form" action="/user/pemetaan/store/2" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <input type="hidden" name="pilihan11" value="-" />
                        </div>
                        <div class="form-group">
                            <input type="hidden" name="pilihan12" value="--" />
                        </div>
