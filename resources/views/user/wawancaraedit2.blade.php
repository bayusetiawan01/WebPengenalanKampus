...
<section class="content" style="margin-top: 80px;">
    ...
    @endif
    <form action="/user/wawancara2/update" method="post" enctype="multipart/form-data">
        {{ csrf_field() }}
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <div class="body">
                        ...
                        <div class="form-group form-float">
                            <div class="form-line">
                                <textarea rows="4" class="form-control no-resize" name="kekurangan_kelebihan">{{ $isi->kekurangan_kelebihan }}</textarea>
                                <label class="form-label" style="color: #333;">1. Sebutkan kekurangan dan kelebihan anda!</label>
                            </div>
                        </div>
                        <div class="form-group form-float">
                            <div class="form-line">
                                <textarea rows="4" class="form-control no-resize" name="perbedaan_mahasiswa">{{ $isi->perbedaan_mahasiswa }}</textarea>
                                <label class="form-label" style="color: #333;">2. Apa yang kamu ketahui tentang perbedaan siswa dan mahasiswa?</label>
                            </div>
                        </div>
                        <div class="form-group form-float">
                            <div class="form-line">
                                <textarea rows="4" class="form-control no-resize" name="bem_hima">{{ $isi->bem_hima }}</textarea>
                        ...
                        <div class="form-group form-float">
                            <div class="form-line">
                                <textarea rows="4" class="form-control no-resize" name="fungsi_angkatan">{{ $isi->fungsi_angkatan }}</textarea>
                        ...
                        <div class="form-group form-float">
                            <div class="form-line">
                                <textarea rows="2" class="form-control no-resize" name="kritis">{{ $isi->kritis }}</textarea>
                                <label class="form-label" style="color: #333;">- Kritis</label>
                            </div>
                        </div>
                        <div class="form-group form-float">
                            <div class="form-line">
                                <textarea rows="2" class="form-control no-resize" name="solusional">{{ $isi->solusional }}</textarea>
                                <label class="form-label" style="color: #333;">- Solusional</label>
                            </div>
                        </div>
                        <div class="form-group form-float">
                            <div class="form-line">
                                <textarea rows="2" class="form-control no-resize" name="sistematis">{{ $isi->sistematis }}</textarea>
                                <label class="form-label" style="color: #333;">- Sistematis</label>
                            </div>
                        </div>
                        <div class="form-group form-float">
                            <div class="form-line">
                                <textarea rows="2" class="form-control no-resize" name="logis">{{ $isi->logis }}</textarea>
                                <label class="form-label" style="color: #333;">- Logis</label>
                            </div>
                        </div>
                        <div class="form-group form-float">
                            <div class="form-line">
                                <textarea rows="2" class="form-control no-resize" name="berlandasan">{{ $isi->berlandasan }}</textarea>
                                <label class="form-label" style="color: #333;">- Berlandasan</label>
                            </div>
                        </div>
                        <div class="form-group form-float">
                            <div class="form-line">
                                <textarea rows="4" class="form-control no-resize" name="arti_pemimpin">{{ $isi->arti_pemimpin }}</textarea>
                                <label class="form-label" style="color: #333;">6. Apa arti pemimpin menurutmu? Siapa pemimpin idolamu (selain Rasulullah)?</label>
                            </div>
                        </div>
                        <div class="form-group form-float">
                            <div class="form-line">
                                <textarea rows="4" class="form-control no-resize" name="koordinator">{{ $isi->koordinator }}</textarea>
