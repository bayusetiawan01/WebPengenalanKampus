        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                ...
                <div class="body clearfix" style="padding: 50px; padding-top:10px">
                    ...
                    Terimakasih kamu telah memilih kegiatan pemetaan Internship Program BPM Kema FMIPA Unpad sebagai pilihan pertama.<br><br>
                    ...
                    <form id="form" action="/user/pemetaan/store/2" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <select id="pilihan11" name="pilihan11">
                                <option value="Komisi 1" <?php if ($pemetaan->pilihan11 == 'Komisi 1') : ?> selected <?php endif ?>>Komisi 1</option>
                                <option value="Komisi 2" <?php if ($pemetaan->pilihan11 == 'Komisi 2') : ?> selected <?php endif ?>>Komisi 2</option>
                                <option value="Komisi 3" <?php if ($pemetaan->pilihan11 == 'Komisi 3') : ?> selected <?php endif ?>>Komisi 3</option>
                                <option value="Deputi Administrasi dan Rumah Tangga" <?php if ($pemetaan->pilihan11 == 'Deputi Administrasi dan Rumah Tangga') : ?> selected <?php endif ?>>Deputi Administrasi dan Rumah Tangga</option>
                                <option value="Deputi Pengembang Organisasi" <?php if ($pemetaan->pilihan11 == 'Deputi Pengembang Organisasi') : ?> selected <?php endif ?>>Deputi Pengembang Organisasi</option>
                                <option value="Deputi Media, Komunikasi, dan Informasi" <?php if ($pemetaan->pilihan11 == 'Deputi Media, Komunikasi, dan Informasi') : ?> selected <?php endif ?>>Deputi Media, Komunikasi, dan Informasi</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <label for="pilihan12">Pilihan 2</label>
                            <select id="pilihan12" name="pilihan12">
                                <option value="Komisi 1" <?php if ($pemetaan->pilihan12 == 'Komisi 1') : ?> selected <?php endif ?>>Komisi 1</option>
                                <option value="Komisi 2" <?php if ($pemetaan->pilihan12 == 'Komisi 2') : ?> selected <?php endif ?>>Komisi 2</option>
                                <option value="Komisi 3" <?php if ($pemetaan->pilihan12 == 'Komisi 3') : ?> selected <?php endif ?>>Komisi 3</option>
                                <option value="Deputi Administrasi dan Rumah Tangga" <?php if ($pemetaan->pilihan12 == 'Deputi Administrasi dan Rumah Tangga') : ?> selected <?php endif ?>>Deputi Administrasi dan Rumah Tangga</option>
                                <option value="Deputi Pengembang Organisasi" <?php if ($pemetaan->pilihan12 == 'Deputi Pengembang Organisasi') : ?> selected <?php endif ?>>Deputi Pengembang Organisasi</option>
                                <option value="Deputi Media, Komunikasi, dan Informasi" <?php if ($pemetaan->pilihan12 == 'Deputi Media, Komunikasi, dan Informasi') : ?> selected <?php endif ?>>Deputi Media, Komunikasi, dan Informasi</option>
                            </select>
                        </div>
